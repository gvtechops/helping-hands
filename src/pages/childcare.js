  ...
  return (
    <div className="main-div">
      ...
      <div className="two-column-wrapper">
        ...
        <div className="two-column2">
          ...
          <p className="description-paragraphs">
            ...
            funding through 9/27/2024. No webpage currently, only accessed
      ...
      <div className="outro-paragraph">
        ...
        <p>
          Adults, age 18 or older, who are enrolled to provide child care for up
          to six children at a time. License-exempt providers can provide care
          in their own home or the child's home if they are related by blood,
          marriage, or adoption as a grand parent, aunt, uncle, or sibling if
          not living together.
        </p>
        <p>
        ...
        <p>
          Find more information and the application on the Michigan.gov website{" "}
        </p>
        <a
          target="_blank"
          rel="noreferrer"
      ...
      <div className="containing-div2">
        ...
        <div className="two-column2">
          ...
          <p>
            <b>
              If you want to quickly find out if you qualify for funding for
              your childcare,
            </b>{" "}
